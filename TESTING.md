...
| File | What it covers |
|------|---------------|
| `test_models.py` | Embedding networks (MLP, CNN1D, VarMLP, GRU, LSTM, TCN, Transformer), critic architectures (Separable, Concat, Hybrid), chunking equivalency, gradient computation, `get_embeddings()` |
