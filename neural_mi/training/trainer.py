...
class Trainer:
    ...
    def train(self, x_data, y_data, n_epochs, batch_size,
        ...
        # The model is now moved to the device of the input data
        ...
        for epoch in epoch_pbar:
            ...
            if epochs_no_improve >= patience:
                # --- CHANGE: More informative early stopping message ---
        ...
        self.model.load_state_dict(torch.load(temp_model_path, map_location=x_data.device, weights_only=True))
        self.model.eval()
        with torch.no_grad():
